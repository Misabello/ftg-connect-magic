...
export const Route = createFileRoute("/_authenticated/administracion")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cuentas por cobrar y pagar, tesorería, arqueos y flujo de caja." },
      { property: "og:title", content: "Administración — FTG ONE" },
      { property: "og:description", content: "Cuentas por cobrar y pagar, tesorería, arqueos y flujo de caja." },
...
function Administracion() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={tab} onValueChange={(v) => setTab(v as FinanceDocKind)}>
        <TabsList>
